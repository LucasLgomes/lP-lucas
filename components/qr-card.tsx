...
export function QrCard() {
  return (
    ...
    >
      {/* QR code — aponta pra raiz do portfolio */}
      ...
      <div className="text-center sm:text-left">
        <div className="mb-1 inline-flex items-center gap-1.5 rounded-full bg-brand-violet/15 px-2.5 py-0.5 text-[10px] font-medium text-brand-violetLight ring-1 ring-brand-violet/30">
          ...
          Leve meu portfólio no bolso
        </div>
        <h3 className="mt-1 font-display text-lg font-semibold text-white">
          Escaneie e abra meu portfólio
        </h3>
        <p className="mt-1 text-xs text-white/60 sm:text-sm">
          Aponte a câmera do celular no QR code — abre esse site direto no seu
          navegador. E se quiser, leve também o currículo em PDF:
        </p>
